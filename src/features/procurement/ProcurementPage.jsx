...
export default function ProcurementPage() {
  ...
  const getStatusChip = (status) => {
    let color = 'default';
    if (status === 'Approved') color = 'success';else
    if (status === 'Pending Approval') color = 'warning';else
  ...
  const getPriorityChip = (priority) => {
    let color = 'default';
    if (priority === 'Critical') color = 'error';else
    if (priority === 'High') color = 'warning';else
