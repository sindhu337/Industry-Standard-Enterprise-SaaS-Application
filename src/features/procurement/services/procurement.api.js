 ...
 * Simulates async API calls using mock data.
 * Swap these implementations with real axios calls when a backend is ready.
 */
import { PROCUREMENT_MOCK_DATA } from '../data/procurementMockData'

const delay = (ms = 400) => new Promise((res) => setTimeout(res, ms))

// In-memory store (module-level singleton for mock persistence)
...
export const procurementApi = {
  ...
  /**
   * Fetch a single procurement request by ID
   */
  async getById(id) {
    await delay(250)
